...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;g.Gh("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",g.Dh,c)}},Z8=function(a,b){K8();
...
return a?a.friendlyName:null},Uwa=function(a,b,c,d,e){Lwa()?Kwa(b,e)&&(N8(!0),window.chrome&&window.chrome.cast&&window.chrome.cast.isAvailable?Awa(a,c):(window.__onGCastApiAvailable=function(b,d){b?Awa(a,c):(Q8("Failed to load cast API: "+d),P8(!1),N8(!1),g.PG("yt-remote-cast-available"),g.PG("yt-remote-cast-receiver"),vwa(),c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):Cwa():Nwa())):G8("Cannot initialize because not running Chrome")},
