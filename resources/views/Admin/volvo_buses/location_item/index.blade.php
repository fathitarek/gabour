...
<article>
    <a href="/Admin/volvo_buses/locationsItem/create" class="btn btn-primary">ADD New Location Item</a>
       <a href="/Admin/volvo_buses/locationsItem/export" class="btn btn-primary">Export Location Item</a>
       @include('Admin.form_parcials.upload_excel',['url'=>'/Admin/volvo_buses/locationsItem/import'])
