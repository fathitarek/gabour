...
<div class="bread-crumb"><p><a href="{{action('SliderController@index')}}">Sliders</a> / <span>Update Slider</span></p></div>
    <hr/>

    {!!Form::model($record,['method' =>'PATCH', 'action'=>['SliderItemController@update',$record->id],'files' => true])!!}
