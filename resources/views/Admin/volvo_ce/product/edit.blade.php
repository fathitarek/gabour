...
{!!Form::model($record,['method' =>'PATCH', 'action'=>['ProductController@update',$record->id],'files' => true])!!}
            ...
            @include('Admin.form_parcials.universal_text_field',['name'=>'title2_ar','label'=>'Arabic Title2:'])
            @include('Admin.form_parcials.universal_text_field',['name'=>'display_name','label'=>'Display Name:'])
            @include('Admin.form_parcials.universal_text_field',['name'=>'display_name_ar','label'=>'Display Name:'])
