<div class="row heroX">
        <div class="col-md-10 col-md-offset-1">
          <div id="carousel1" class="carousel slide" data-ride="carousel">
            ...
            @if(count($page['trucks_slider_ar']['special_listing_1_data'][0]->sliderItems))
            <?php
		$slider_index=0;
		?>
            <div class="carousel-inner" role="listbox">
                 @foreach($page['trucks_slider_ar']['special_listing_1_data'][0]->sliderItems as $index =>$slider_item)
              ...
              <div class="item active"><img src="/{{$current_website->name}}/images/{{$slider_item->img}}" alt="{{$slider_item->title}}" class="center-block">
                <div class="carousel-caption">
                  ...
                  <a href="{{$slider_item->url}}">
                    <p class="btnX">{{$slider_item->url_title}}<span class="glyphicon glyphicon-chevron-right"></span></p>
                  </a> 
