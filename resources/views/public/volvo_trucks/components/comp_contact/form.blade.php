    ...
    <h3 class="head_style_a" id="thnk_msg" style=" padding-left: 173px;">Thank You for your message</h3>
        @endif
...
<!--<div class="col-md-2 text-center col-md-offset-2">
            ...
            <div>
              <form method="post"  action="/volvo_trucks/contact_us/send" name="form1" class="formX" id="form1">
                <div>
