...
{!!$page->template->includes!!}
  ...
  <div class="container-fluid" id="pageX">
    ...
    <div class="contentX">
     ...
     ?>
          @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['p_right_image_first']['component_template']['path'])
           @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['2blocks']['component_template']['path'])
