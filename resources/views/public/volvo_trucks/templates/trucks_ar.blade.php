...
{!!$page->template->includes!!}
  ...
  <div class="container-fluid" id="pageX">
    ...
    <div class="contentX">
     ...
     ?>
       @include('public.'.$current_website->name.'.components.'.'.comp_trucks.'.$page['trucks_slider_ar']['component_template']['path'])

      <?php //include("components/comp_index/head_title.php");
     ?>

      
     @include('public.'.$current_website->name.'.components.'.'.comp_trucks.'.$page['our_trucks']['component_template']['path'])
     ...
     ?>
    @include('public.'.$current_website->name.'.components.'.'.comp_trucks.'.$page['p_left_image_first']['component_template']['path'])

        @include('public.'.$current_website->name.'.components.'.'.comp_about_dealer.'.$page['about']['component_template']['path'])
