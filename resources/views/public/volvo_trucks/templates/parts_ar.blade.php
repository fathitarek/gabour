...
{!!$page->template->includes!!}
  ...
  <div class="container-fluid" id="pageX">
    ...
    <div class="contentX">
     ...
     @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['image']['component_template']['path'])
     @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['head_title_lower']['component_template']['path']) 
     @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['image2']['component_template']['path'])
     @include('public.'.$current_website->name.'.components.'.'.comp_parts.'.$page['head_title_parts']['component_template']['path'])
     @include('public.'.$current_website->name.'.components.'.'.comp_parts.'.$page['know_more_upper']['component_template']['path'])
     @include('public.'.$current_website->name.'.components.'.'.comp_parts.'.$page['title_4_sections']['component_template']['path'])
