...
{!!$page->template->includes!!}
  ...
  <div class="container-fluid" id="pageX">
    ...
    <div class="contentX">
     ...
     ?>
       ...
       @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['head_title']['component_template']['path'])
             ...
             @include('public.'.$current_website->name.'.components.'.'.comp_parts.'.$page['p_right_image_second']['component_template']['path'])
             @include('public.'.$current_website->name.'.components.'.'.comp_parts.'.$page['p_right_image_third']['component_template']['path'])
   ...
   @include('public.'.$current_website->name.'.components.'.'.comp_index.'.$page['know_more']['component_template']['path'])
    ...
    @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['service']['component_template']['path'])
