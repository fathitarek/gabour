  ...
  <div class="container-fluid" id="pageX">
    ...
    <div class="contentX">
     ...
     ?>
       ...
       @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['contract_service1']['component_template']['path'])

             
             
             
             
   @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['qoute']['component_template']['path'])
      @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['image1']['component_template']['path'])
      @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['rapid']['component_template']['path'])
       @include('public.'.$current_website->name.'.components.'.'.comp_service.'.$page['know_more_video']['component_template']['path'])
        @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['head_title_lower']['component_template']['path'])

                @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['green']['component_template']['path'])
                 @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['benefits']['component_template']['path'])
      @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['image2']['component_template']['path'])
      @include('public.'.$current_website->name.'.components.'.'.comp_rapid.'.$page['media_gallary_ar']['component_template']['path'])
