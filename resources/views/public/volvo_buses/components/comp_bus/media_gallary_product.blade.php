                    ...
                    <div class="grid-wrapper">
                        ...
                        <div class="grid-container">
                            <ul id="grid" class="grid my-comp-016c2240-0cf8-42e2-b878-f150ab4f6e80">
                                ...
                                @if(count($page['media_gallary_product']['special_listing_1_data'][0]->sliderItems))
                                @foreach($page['media_gallary_product']['special_listing_1_data'][0]->sliderItems as $index =>$slider_item)
