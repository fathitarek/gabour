...
<div class="row" id="logo">
    <div class="col-md-10 col-md-offset-1"><a href="{{$page['main_menu']['component_data']['link_cv']}}"><img src="/{{$current_website->name}}/uploads/{{$page['main_menu']['component_data']['file_1']}}" alt=""/></a>
        <a href="/volvo_buses/home" > 
            <img src="/{{$current_website->name}}/uploads/{{$page['main_menu']['component_data']['file_2']}}" alt="" class="volvoLogo"/></a>
    </div>
</div>
...
<li class="dropdown yamm-fw"><a href="{{$page['main_menu']['special_listing_5_data'][0]->url}}" class="dropdown-toggle"  role="button" aria-haspopup="true" aria-expanded="false">{{$page['main_menu']['special_listing_5_data'][0]->display_name}}</a></li>

 <li class="dropdown yamm-fw"><a  href="{{$page['main_menu']['special_listing_6_data'][0]->url}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$page['main_menu']['special_listing_6_data'][0]->display_name}}</a>
 <ul class="dropdown-menu">
        <li>
            
            <div class="row noPaddingX">
                @foreach($page['main_menu']['special_listing_6_data'][0]->menuItems as $index =>$menu_item)
                 @if($menu_item->published==1)
