<div class="row headTitleX">
    <div class="col-md-10 col-md-offset-1">
        <h4>{{$page['our_offering_ar']['component_data']['big_title']}} </h4>
    </div>
</div>
...
<!--                                                         -->
            <div class="col-md-4"><img src="/{{$current_website->name}}/uploads/{{$page['our_offering_ar']['component_data']['file_1']}}" class="img-responsive" alt="Placeholder image">
                <h5>{{$page['our_offering_ar']['component_data']['title1']}} </h5>
                <p> {{$page['our_offering_ar']['component_data']['desc1']}}</p>
                <a href="{{$page['our_offering_ar']['component_data']['link1']}}">{{$page['our_offering_ar']['component_data']['title_btn1']}}<span class="glyphicon glyphicon-menu-right
                                            "></span></a></div>
        </div>
    </div>
</div>