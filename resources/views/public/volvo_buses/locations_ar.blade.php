...
<div class="row" id="logo">
    <div class="col-md-10 col-md-offset-1"><a href="{{$component->link_cv}}"><img src="/{{$current_website->name}}/uploads/{{$component->file_1}}" alt=""/></a>
        <a href="/volvo_buses/home" >     <img src="/{{$current_website->name}}/uploads/{{$component->file_2}}" alt="" class="volvoLogo"/></a>
    </div>
</div>
...
<li class="dropdown yamm-fw"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$menu_offering->display_name}}</a>
        ...
        <li>
            <div class="row noPaddingX">
                <div class="col-md-9 rightBorderX">
                    <div class="row">
                        <div class="col-md-4">
                        @foreach($menu_offering->menuItems as $index =>$menu_item)
...
<li class="dropdown yamm-fw"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$menu_services->display_name}}</a>
 ...
 <li class="dropdown yamm-fw"><a  href="{{$menu_news->url}}"  role="button" aria-haspopup="true" aria-expanded="false">{{$menu_news->display_name}}</a></li>
 <li class="dropdown yamm-fw"><a id="con" href="{{$menu_locations->url}}"  role="button" aria-haspopup="true" aria-expanded="false">{{$menu_locations->display_name}}</a></li>
...
<li class="dropdown yamm-fw"><a href="{{$menu_contactus->url}}"  role="button" aria-haspopup="true" aria-expanded="false">{{$menu_contactus->display_name}}</a></li>
 ...
 <li class="dropdown yamm-fw"><a  href="{{$menu_aboutus->url}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$menu_aboutus->display_name}}</a>
 <ul class="dropdown-menu">
        <li>
...
<p>{{$settings->text_ar}}</p>
                            ...
                            <div class="col-md-7 text-center">
                                {!!Form::open(['action'=>'VolvoPagesController@locations_buses_ar','method' => 'GET'])!!}
                                <div>
