...
<div class="row mobileSecond">
  <img src="/{{$current_website->name}}/images/{{$settings->img_en}}" class="img-responsive" alt="Placeholder image"> </div>
  <div class="container-fluid" id="pageX">
    <div class="row secondRowX" id="locationsX">
      <div class="col-sm-10 col-sm-offset-1">&nbsp;
        <div class="col-sm-12">
          <h3 class="h3X">OUR</h3>
          <h2 class="h2X">LOCATIONS</h2>
          <br>  

          
          <p class="p col-sm-9">{{$settings->text_en}}</p>
        </div>
      </div>
    </div>
</div>
     ...
     {!!Form::open(['action'=>'GcvPagesController@locations','method' => 'GET'])!!}
...
<select  name='city_id' class="btn" style="color:#fff; border: none;">
      ...
      @include('Admin.form_parcials.submit_btn',['submit_btn_text'=>'search'])
                    {!!Form::close()!!}              </div>
 ...
 <footer class="row">
    ...
    <div class="col-sm-5 col-sm-offset-1 mortimerHarvey col-xs-6">All Rights Reserved 2017</div>
