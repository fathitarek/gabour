...
<html dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Trucks | Mitsubishi Fuso</title>
...
<div id="CONTENTS_AREA" class="clearfix">
    <div id="MAIN_CONTENTS" class="clearfix">
		<div class="center">
<div class="par parsys"><div class="header section"><div>



    <h3 class="head_style_a" style="direction: rtl"> عربات النقل</h3>
...
<div class="divider section"><div>
    ...
    <hr>
                   ...
                   @include('public.'.$current_website->name.'.components.'.$page['heavy_duty_trucks']['component_template']['path'])
...
<div class="text parbase section">
            ...
            @include('public.'.$current_website->name.'.components.'.$page['praghraph_trucks']['component_template']['path'])
