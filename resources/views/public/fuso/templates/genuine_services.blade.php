...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Genuine Services | Mitsubishi Fuso</title>
...
<div class="tabs section"><div>
    <ul id="EXEC_TAB">
        <li><a class="active" href="/fuso/genuine_services">Genuine Services</a></li>
    
        <li><a href="/fuso/we_promise">WE PROMISE!</a></li>
    
        <li><a href="/fuso/inspection_and_maintenance">Inspection &amp; Maintenance</a></li>
    </ul>
    <br style="clear:both">
</div></div>
        @include('public.'.$current_website->name.'.components.'.$page['title_desc']['component_template']['path'])
@include('public.'.$current_website->name.'.components.'.$page['genuine_services']['component_template']['path'])

<?php// include("components/title_desc.php");  
// include("components/genuine_services.php");
 ?>

</div></div>
<?php // include("components/genuine_services_paragraph.php");
?>
@include('public.'.$current_website->name.'.components.'.$page['genuine_services_paragraph']['component_template']['path'])
