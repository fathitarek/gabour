...
<div class="tabs section"><div>
          <ul id="EXEC_TAB">
                    ...
                    <li><a class="active" href="/fuso/genuine_accessories_ar">إكسسوار فوزو</a></li>
...
<div class="header section"><div>
    ...
    @include('public.'.$current_website->name.'.components.'.$page['genuine_accessories_leaflet_download_ar']['component_template']['path'])
