...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>We Promise | Mitsubishi Fuso</title>
...
<div class="tabs section"><div>
    <ul id="EXEC_TAB">
        <li><a href="/fuso/genuine_services">Genuine Services</a></li>
    
        <li><a href="/fuso/we_promise" class="active">WE PROMISE!</a></li>
    
        <li><a href="/fuso/inspection_and_maintenance">Inspection &amp; Maintenance</a></li>
    </ul>
    <br style="clear:both">
</div></div>

<?php //include("components/inner_page_featured_photo.php"); 
?>
     @include('public.'.$current_website->name.'.components.'.$page['inner_page_featured_photo']['component_template']['path'])
...
<div class="showborderaroundrow-">
        ...
        <div class="acs-commons-column-wrapper">
            ...
            <div class="acs-commons-resp-colctrl-col acs-commons-resp-colctrl-col-45 showborderbetweencolumns-">
                  <div class="par1 parsys"><div class="text parbase section">

<link rel="stylesheet" href="/etc/clientlibs/wcm/foundation/accessibility.css" type="text/css">
...
<?php 
//include("components/right_img_wepromise.php");
?>

    
<script type="text/javascript">
    (function() {
        var imageDiv = document.getElementById("cq-image-jsp-/content/fuso/en/service/service/promis/jcr:content/par/column_control/par1/image");
        var imageEvars = '{ imageLink: "", imageAsset: "/content/dam/core/image/service/promise/promise_h3.png", imageTitle: "promise_h3" }';
...
<?php //include('components/wepromise_text.php'); 
?>
     @include('public.'.$current_website->name.'.components.'.$page['wepromise_text']['component_template']['path'])
            ...
            <div class="acs-commons-resp-colctrl-col acs-commons-resp-colctrl-col-55 showborderbetweencolumns-">
...
<?php
 //include('components/wepromise_img.php');

 ?>
       @include('public.'.$current_website->name.'.components.'.$page['right_img_wepromise']['component_template']['path'])
    </div>

<script type="text/javascript">
    (function() {
        var imageDiv = document.getElementById("cq-image-jsp-/content/fuso/en/service/service/promis/jcr:content/par/column_control/par2/image");
        var imageEvars = '{ imageLink: "", imageAsset: "/content/dam/core/image/service/promise/promise_pict.png", imageTitle: "promise_pict" }';
        var tagNodes = imageDiv.getElementsByTagName('A');
        for (var i = 0; i < tagNodes.length; i++) {
            var link = tagNodes.item(i); 
            link.setAttribute('onclick', 'CQ_Analytics.record({event: "imageClick", values: ' + imageEvars + ', collect: false, options: { obj: this }, componentPath: "fuso/components/image"})');
