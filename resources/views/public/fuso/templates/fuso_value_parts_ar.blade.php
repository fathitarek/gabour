...
<html dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <title>fuso value parts | Mitsubishi Fuso</title>
...
<div class="tabs section"><div>
    <ul id="EXEC_TAB">
                    <li><a  href="/fuso/genuine-parts_ar">قطع الغيار الاصليه</a></li>

                    <li><a class="active" href="/fuso/fuso_value_parts_ar">قطع غيار فوسو</a></li>

                    <li><a href="/fuso/genuine_accessories_ar">إكسسوار فوزو</a></li>
                </ul>
    <br style="clear:both" />
</div></div>
...
<?php //include('components/value_parts_tab2_text_2image.php');
?>
    
    @include('public.'.$current_website->name.'.components.'.$page['value_parts_tab2_text_2image']['component_template']['path'])

<div class="header section"><div>
    <h3 class="head_style_a"> تحميل المنشورات </h3>
</div>


   @include('public.'.$current_website->name.'.components.'.$page['The_benefits_of_Fuso_Genuine_Parts_ar']['component_template']['path'])
