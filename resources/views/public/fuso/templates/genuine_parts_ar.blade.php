...
<div id="CONTENTS_AREA" class="clearfix">
    <div id="MAIN_CONTENTS" class="clearfix">
        ...
        <div class="tabs section"><div>
                <ul id="EXEC_TAB">
                    <li><a class="active" href="/fuso/genuine-parts_ar">قطع الغيار الاصليه</a></li>

                    <li><a href="/fuso/fuso_value_parts_ar">قطع غيار فوسو</a></li>
    ...
    <?php //include("components/The_benefits_of_Fuso_Genuine_Parts.php");
    ?>
    ...
    <div class="header section"><div>
            ...
            <h2>مميزات قطع غيار فوسو الاصليه</h2>
        ...
        @include('public.'.$current_website->name.'.components.'.$page['the_benefits_ar']['component_template']['path'])
