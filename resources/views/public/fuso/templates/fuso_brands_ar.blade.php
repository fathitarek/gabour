...
<body class="en_mode">
<script src="/fuso/assets/PartsAccessories_files/ie_download.js.download"></script>
...
<div id="CONTENTS_AREA" class="clearfix">homepage_main_menu_arabic
...
@include('public.'.$current_website->name.'.components.'.$page['history_img1_fuso_brand']['component_template']['path'])

@include('public.'.$current_website->name.'.components.'.$page['history_img2_fuso_brand']['component_template']['path'])
