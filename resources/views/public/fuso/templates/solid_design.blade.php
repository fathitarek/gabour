...
<div id="CONTENTS_AREA" class="clearfix">
  ...
  @include('public.'.$current_website->name.'.components.'.$page['head_title']['component_template']['path'])
  @include('public.'.$current_website->name.'.components.'.$page['head_img_text']['component_template']['path'])
  @include('public.'.$current_website->name.'.components.'.$page['page_tabs']['component_template']['path'])
  @include('public.'.$current_website->name.'.components.'.$page['left_img_text']['component_template']['path'])
  @include('public.'.$current_website->name.'.components.'.$page['image']['component_template']['path'])
