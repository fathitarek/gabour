...
<html dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Roadside Assistance | Mitsubishi Fuso</title>
...
<div class="par parsys">
  ...
  ?>
       @include('public.'.$current_website->name.'.components.'.$page['inner_page_featured_photo']['component_template']['path'])
        ...
        <br>
        <br>
<?php //include("components/parts_head_and_text.php");
?>
       @include('public.'.$current_website->name.'.components.'.$page['parts_head_and_text']['component_template']['path'])
...
<?php // include("components/inner_page_featured_photo.php"); 
?>
       @include('public.'.$current_website->name.'.components.'.$page['inner_page_featured_photo2']['component_template']['path'])
...
<?php // include("components/parts_head_and_text.php");
?>
       @include('public.'.$current_website->name.'.components.'.$page['parts_head_and_text2']['component_template']['path'])
