...
<!-- saved from url=(0057)http://www.mitsubishi-fuso.com/content/fuso/en/index.html -->
<html dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
    
    <title>Mitsubishi Fuso Truck and Bus Corporation</title>
...
<body class="en_mode index-page">
<script src="./ar/assets/ie_download.js.download"></script>
...
@include('public.'.$current_website->name.'.components.'.$page['fuso_home_slider_arabic']['component_template']['path'])

@include('public.'.$current_website->name.'.components.'.$page['top_menu_area']['component_template']['path'])
<div class="ennewsmapsection section"><div>
@include('public.'.$current_website->name.'.components.'.$page['contactus_box']['component_template']['path'])



@include('public.'.$current_website->name.'.components.'.$page['homepage_map']['component_template']['path'])
