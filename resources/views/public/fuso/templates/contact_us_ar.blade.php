...
<html dir="rtl"><head>
        ...
        <link rel="stylesheet" href="ar/fuso/PartsAccessories_files/colctrl.css" />
        <link href="ar/css/bootstrap.css" rel="stylesheet" type="text/css" />
    ...
    <body class="en_mode">
        <script src="ar/fuso/PartsAccessories_files/ie_download.js.download"></script>
                    ...
                    <div class="center">
                        <div class="par parsys">
                            <div class="header section">
                                <div>
                                    <h3 class="head_style_a" style="direction: rtl">اتصل بنا</h3>
                                </div>
                            </div>
                            ...
                            <br>
                                ...
                                <div class="header section">
                                    <div>
                                        <br>
                                            ...
                                            <h3 class="head_style_a" style="direction: rtl">شكرا لارسال الرساله</h3>
                                            @endif
                                            <h3 class="head_style_a" style="direction: rtl">يمكنك ارسال رسالتك</h3>
                                ...
                                <div class="row" id="formDiv">
                                    ...
                                    <div class="col-lg-8 col-lg-offset-2">
                                        ...
                                        <form id="form1" method="post" action="/fuso/contact_us_ar/send" style="direction: rtl">
                                            <input name="_token" hidden value="{!! csrf_token() !!}" />

                                            <div class="btn-group">
                                                {{--<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-h                                                aspopup="true" aria-expanded="fa                                                lse">--}}
                                                {{--Type of Inquiry--}}
                                                {{--<span class="caret"></span>--}}
                                                           ...
                                                           {{--<li role="presentation" class="disab                                                        led"><a href="#">Disa                                                        bled Link</a></li>--}}
                                                                        {{--<li role="pre                                                        sentation" class="divider"></li>--}}
                                                                    {{--<li role="presentation"><a h                                                        ref="#">Separated Link</a></li>--}}
                                                {{--</ul>--}}
                                                                      {{--</div>--}}
                                                {{--<ul class="dropdown-menu">--}}
        ...
        {!!Form::text('mobile',null,['class'=> 'form-control','placeholder'=>'الموبايل / رقم الهاتف المحمول']) !!}
        {!!Form::email('email',null,['class'=> 'form-control','required'=>'required','placeholder'=>'البريد الالكترونى']) !!}
        {!!Form::textarea('message',null,['class'=> 'form-control','required'=>'required','rows'=> '6','id'=> 'comment','placeholder'=>'رسالتك']) !!}
 ...
 {!!Form::hidden('website_id',$current_website->id,['id'=>'website_id']) !!}
        ...
        {!!Form::submit('ارسال',['class'=> 'btn btn-info col-sm-4 col-sm-offset-8 btn-danger','value'=>'ارسال']) !!}
