...
<div id="CONTENTS_AREA" class="clearfix">
    <div id="MAIN_CONTENTS" class="clearfix">
        ...
        <div class="tabs section"><div>
                ...
                <ul id="EXEC_TAB">
                    <li><a class="active" href="/fuso/genuine_parts">Genuine Parts</a></li>

                    <li><a href="/fuso/fuso_value_parts">Fuso Value Parts</a></li>

                    <li><a href="/fuso/genuine_accessories">Genuine Accessories</a></li>
                </ul>
    ...
    <div class="header section"><div>
            ...
            <h2>The benefits of Fuso Genuine Parts</h2>
        ...
        @include('public.'.$current_website->name.'.components.'.$page['the_benefits']['component_template']['path'])
