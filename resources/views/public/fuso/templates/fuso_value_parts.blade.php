...
<div class="tabs section"><div>
    <ul id="EXEC_TAB">
        ...
        <li><a href="/fuso/fuso_value_parts" class="active">Fuso Value Parts</a></li>
...
<div class="header section"><div>
   ...
   @include('public.'.$current_website->name.'.components.'.$page['The_benefits_of_Fuso_Genuine_Parts']['component_template']['path'])
