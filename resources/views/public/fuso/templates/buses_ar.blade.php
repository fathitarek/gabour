...
<html dir="rtl"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Buses | Mitsubishi Fuso</title>
...
<div class="par parsys"><div class="header section"><div>
    ...
    <h3 class="head_style_a">الاوتوبيسات</h3>
...
<div class="divider section"><div>
    ...
    <hr>
                   ...
                   @include('public.'.$current_website->name.'.components.'.$page['heavy_duty_buses']['component_template']['path'])
...
<div class="text parbase section">
            ...
            @include('public.'.$current_website->name.'.components.'.$page['praghraph_buses']['component_template']['path'])
