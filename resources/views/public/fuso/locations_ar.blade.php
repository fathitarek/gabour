...
<html dir="rtl"><head>
    ...
    <title>location | Mitsubishi Fuso</title>
    ...
    <link rel="stylesheet" href="./ar/assets/main.css" type="text/css" />
<script async="" src="./ar/assets/analytics.js.download"></script>
<script type="text/javascript" charset="UTF-8" async="" src="./ar/assets/alog.js.download"></script>
<script type="text/javascript" src="./ar/assets/jquery.js.download"></script>
<script type="text/javascript" src="./ar/assets/utils.js.download"></script>
<script type="text/javascript" src="./ar/assets/granite.js.download"></script>
<script type="text/javascript" src="./ar/assets/jquery.js(1).download"></script>
<script type="text/javascript" src="./ar/assets/main.js.download"></script>
<link rel="stylesheet" href="./ar/assets/main(1).css" />

<link href="./ar/assets/default.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="./ar/assets/clientlibrarymanager.js.download"></script>
...
<link rel="stylesheet" href="./ar/assets/reset.css" />
<link rel="stylesheet" href="./ar/assets/parts.css" />
<link rel="stylesheet" href="./ar/assets/colorbox.css" />
<link rel="stylesheet" href="./ar/assets/jquery.bxslider.css" />
<link rel="stylesheet" href="./ar/assets/main(1).css" />
<link rel="stylesheet" href="./ar/assets/en.css" />
<script src="./ar/assets/init_3rd.js.download"></script>
...
<script src="./ar/assets/jquery.min.js.download"></script>
<script src="./ar/assets/jquery.bxslider.js.download"></script>
<script src="./assets/common.js.download"></script>
<script src="./ar/assets/analytics.js(1).download"></script>
<script src="./ar/assets/usonar.js.download"></script>
<script src="./ar/assets/navigation.js.download"></script>
<script src="./ar/assets/jquery.colorbox.js.download"></script>
<script src="./ar/assets/distributors.js.download"></script>
<script src="./ar/assets/jquery-ui.min.js.download"></script>
<script src="./ar/assets/jquery.magnific-popup.min.js.download"></script>
<link rel="stylesheet" href="./ar/assets/jquery.magnific-popup.css" />
    ...
    <script>
            ...
            function initialize() {
                ...
                @foreach($locations as $index => $location)
                        ...
                        var location = ['{{$location['name_ar']}}<br/>{{$location['address_ar']}}<br/>{{$location['phone']}}', '{{trim($location['long'])}}', '{{trim($location['lat'])}}'];
  ...
  <div class="menu">
    <div>
      ...
      <header id="HEADER_AREA" style="z-index: 50000;">
               <div id="HEADER_WRAP">
          <h1> <a href="/fuso/home_ar"> <img class="pc_display" src="./PartsAccessories_files/NewLogo.png" alt="mitsubishifuso"> <img class="mb_display" src="./PartsAccessories_files/NewLogo.png" alt="mitsubishifuso"></a></h1>
                                        ...
                                        <li class="menu_all clearfix" id="{{$menu_item->name}}"> <a href="#" class="menu_all"> <img src="/fuso/images/menu_items/{{$menu_item->image_on}}" alt="{{$menu_item->display_name}}" class="p_gnv pc_display" data-pin-nopin="true" /> <span class="mb_icon mb_display"> <img src="./assets/mb_menu_products.png" alt="{{$menu_item->display_name}}" class="p_gnv" /></span> <span class="mb_txt mb_display">{{$menu_item->display_name}}</span></a>
                                            <ul class="submenu clearfix" style="display: none;">
                                                @foreach($menu_item->menuItems as $sub_index =>$sub_menu_item)
                                                    ...
                                                    <li> <a href="{{$sub_menu_item->url}}" id="{{explode( '/', $sub_menu_item->url)[0]}}"> <img src="/fuso/images/menu_items/{{$sub_menu_item->image_on}}" alt="{{$sub_menu_item->display_name}}" class="p_gnv pc_display" /> <img src="./assets/active_alw.png" alt="" class="active_alw pc_display" /> <span class="mb_txt mb_display">{{$sub_menu_item->display_name}}</span></a></li>
                                                @endforeach
                                            </ul>
                                        </li>
                                @else
        ...
        <script>
            document.getElementById("locations").parentElement.parentElement.style="display: block";
            document.getElementById("locations").parentElement.parentElement.parentElement.className="menu_all clearfix selected";
        </script>
      </header>
      <script>
    $(function(){
...
<div class="par parsys">
  <div class="header section">
    <div>
        <h3 class="head_style_a" style="direction: rtl">فروعنا </h3>
    </div>
  </div>
  <div class="image parbase cq-analyzable section"><div id="cq-image-jsp-/content/fuso/en/service/partsandaccessories/genuine_parts/jcr:content/par/image"><img title="genuine_header_image" alt="genuine_header_image" class="cq-dd-image align-left" data-opennewwindow="" src="/{{$current_website->name}}/images/{{$settings->img_ar}}"></div>
    
    
<script type="text/javascript">
    (function() {
        var imageDiv = document.getElementById("cq-image-jsp-/content/fuso/en/service/partsandaccessories/genuine_parts/jcr:content/par/image");
        var imageEvars = '{ imageLink: "", imageAsset: "/content/dam/core/image/service/parts/genuine_header_image.png", imageTitle: "genuine_header_image" }';
...
<!--    <ul id="EXEC_TAB">
      <li><a class="active" href="/fuso/locations">All</a></li>
      <?php //foreach ($locationCategories as $locationCategory) { ?>
      <li><a href="/fuso/locations?location_category_id="><?php //echo $locationCategory->name_en; ?></a></li>
...
<div class="row" id="formDiv">
  <div class="col-lg-12">
    <!--<form id="form1" method="post" action="">-->
      {!!Form::open(['action'=>'FusoPagesController@locations_ar','method' => 'GET'])!!}
         <select  name='city_id' class="btn col-md-10 col-md-offset-1" style="color:#fff; border: none; margin-bottom: 20px;">
         ...
         <div id="formLocationX">
          ...
          <?php foreach ($locationCategories as $locationCategory) { ?>
          <label>
              <input type="radio" name="location_category_id" style="color: #262626;" value="<?=$locationCategory->id;?>" for='<?php echo $locationCategory->name_ar; ?>'/><span class="radioLocationX" style="color: #262626;"><?php echo $locationCategory->name_ar; ?> </span> 
          </label>
             <?php } ?>
                    ...
                    <input type="submit" style="margin-top: 20px; color:#000;" id="searchXbox" class="btn col-md-10 col-md-offset-1" value="ابحث" />
                    {!!Form::close()!!}
<!--</form>-->
  </div>
</div>
...
Address:
Km 3 - Cairo Alexandria Agriculture road, Cairo, Egypt
<br/>
موبايل:<span style="  direction: ltr;unicode-bidi: embed;">+2 02 42104494</span><br/>
فاكس: <span style="  direction: ltr;unicode-bidi: embed;">+2 02 42107797 </span></p>-->
  <p> {{$settings->text_ar}}</p>
  </div>
  <!--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6907.553322779189!2d31.092814125980542!3d30.043264607843867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbda22572370ef888!2sGhabbour+Auto!5e0!3m2!1sen!2seg!4v1494859442771" width="600" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>-->
...
//    
//   $('html body.en_mode span').attr("z-index", "8675309").on('load', function() {
