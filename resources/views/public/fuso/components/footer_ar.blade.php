...
<div id="LAST_AREA" class="clearfix">
    ...
    <address class="COPYRIGHT2">
        <span>جي بي أوتو الموزع المعتمد لميتسوبيشي فوزو <br />
           </span>
    </address>
    <address id="COPYRIGHT">
        <span>©&nbsp; 2017 جي بي أوتو. جميع الحقوق محفوظة</span></address>
    <form action="http://www.mitsubishi-fuso.com/content/fuso/en/search_result.html" name="searchform" class="logoX">
    </form>
    <form action="http://www.mitsubishi-fuso.com/content/fuso/en/search_result.html" name="searchform" id="searchform" class="logoX">
