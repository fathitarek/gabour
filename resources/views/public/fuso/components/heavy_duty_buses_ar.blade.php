        ...
        <div class="acs-commons-column-wrapper">
            <div class="acs-commons-resp-colctrl-col acs-commons-resp-colctrl-col-100 showborderbetweencolumns-">
                <div class="par1 parsys">
                    ...
                    @if(count($page['heavy_duty_buses']['special_listing_1_data']))
                            @foreach($page['heavy_duty_buses']['special_listing_1_data'][0]->categories as $index => $category)
                                @if($category->published==1)
                                    <div class="header section"><div>
                                            <h3 class="head_style_a">{{$category->display_name_ar}}</h3>
                                        </div>
                                    </div>
                                            ...
                                            @if($product->published==1)
                                                <div class="listpageitem section">
                                                    <span style="display: inline-block;">
                                                        <div class="p-img"><img src="/{{$current_website->name}}/images/product/{{$product->image}}" alt="{{$product->title_ar}}"></div>
                                                        <div class="p-nm">{{$product->title_ar}}</div>
