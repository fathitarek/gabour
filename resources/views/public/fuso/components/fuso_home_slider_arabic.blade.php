    ...
    <div>
        <div class="bx-wrapper" style="max-width: 100%;">
            <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; "> 
                ...
                @if(count($page['fuso_home_slider_arabic']['special_listing_1_data'][0]->sliderItems))

                <div id="wowslider-container1">

                    <div class="ws_images">
                        <ul>
                        @foreach($page['fuso_home_slider_arabic']['special_listing_1_data'][0]->sliderItems as $index =>$slider_item)
                   ...
                   <div class="ws_bullets">
                        @foreach($page['fuso_home_slider_arabic']['special_listing_1_data'][0]->sliderItems as $index1 =>$slider_item)
                            @if($slider_item->published==1)
