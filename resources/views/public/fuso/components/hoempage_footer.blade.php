...
<div>
    <dl>
        ...
        <ul>
            ...
            <li>
              <a href="http://www.mitsubishi-fuso.com/content/fuso/en/lineup/truck/index.html">Trucks</a>
            </li>
        </ul>
        </dd>
    </dl>
    ...
    <dl>
        ...
        <ul>
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/service/partsandaccessories/genuine_parts.html">Parts &amp; Accessories</a>
            </li>
        
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/service/service/index.html">Services</a>
            </li>
        
            <li>
              <a href="http://www.mitsubishi-fuso.com/content/fuso/en/service/tco/index.html">Roadside Assistance</a>
            </li>
        </ul>
        </dd>
    </dl>
    ...
    <dl>
        ...
        <ul>
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/aboutus/fusobrand/history.html">Fuso Brand</a>
            </li>
        
            <li>
              <a href="http://www.mitsubishi-fuso.com/content/fuso/en/aboutus/corporate_profile/index.html">Corporate Profile</a>
            </li>
        </ul>
        </dd>
    </dl>
<dl>
  <dt>
            <a href="http://www.mitsubishi-fuso.com/content/fuso/en/index.html#MAP_AREA">Network locations</a>
            
        </dt>
        <dd>
        <ul>
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/usage.html">Showrooms</a>
            </li>
        
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/pi_protection/index.html">Service centers</a>
            </li>
            <li>
                <a href="http://www.mitsubishi-fuso.com/content/fuso/en/pi_protection/index.html">Spare parts outlets</a>
            </li>
        </ul>
        </dd>
  </dl>
