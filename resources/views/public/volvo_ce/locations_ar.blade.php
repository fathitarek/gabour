...
<html lang="en"><!-- InstanceBegin template="/Templates/master.dwt" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <!-- InstanceEndEditable -->
        <!-- Bootstrap -->
       <link href="ar/css/bootstrap.css" rel="stylesheet">
	<link rel="stylesheet" href="ar/css/bootstrap-rtl.css">
	<link href="ar/css/yamm.css" rel="stylesheet">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link href="ar/css/style.css" rel="stylesheet" type="text/css">
                	<link rel="stylesheet" href="/volvo_ce/css/style.css">

	<link rel="stylesheet" href="ar/css/style_rtl.css">
        ...
        <div class="container-fluid" id="pageX">
            <div class="headerX">
                <div class="row" id="nav1">
                    <div class="col-md-offset-1 col-md-10"> <a href="{{$small_component->link1}}">{{$small_component->title1}}</a> <a href="{{$small_component->link2}}">{{$small_component->title2}}</a> <a href="{{$small_component->link3}}">{{$small_component->title3}}</a> <span> <a href="{{$small_component->link_ar}}">Ar </a> / <a href="{{$small_component->link_en}}"> En</a> </span> </div>
                </div>
                <div class="row" id="logo">
                    <div class="col-md-10 col-md-offset-1"><a href="#"><img src="/{{$current_website->name}}/uploads/{{$small_component->file_1}}" alt=""/></a><img src="/{{$current_website->name}}/uploads/{{$small_component->file_2}}" alt="" class="volvoLogo"/>
                        <form class="navbar-form" id="searchNav" role="search">
                            <div class="input-group add-on">
                                <input class="form-control" placeholder="بحث" name="srch-term" id="srch-term" type="text">
                ...
                <div class="col-md-9 rightBorderX">
                    <h4>{{$component->title_product}}</h4>
                    <p>{{$component->desc_product}}</p>
                   <div class="row">
                        <div class="col-md-4">
                        ...
                        @endforeach 
                                        ...
                                        <li class="dropdown yamm-fw"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$menu_attachments->display_name}}</a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                 <div class="row noPaddingX">
                <div class="col-md-9 rightBorderX">
                    <h4>{{$component->title_attachment}}</h4>
                    <p>{{$component->desc_attachment}}</p>
                   <div class="row">
                        <div class="col-md-4">
                        @foreach($menu_attachments->menuItems as $index =>$menu_item)
                        ...
                        @endforeach 
                                        ...
                                        <li class="dropdown yamm-fw"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$menu_parts->display_name}}</a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <div class="row noPaddingX">

                                                        @foreach($menu_parts->menuItems as $index =>$menu_item)
                             ...
                             <!--                          <div class="rightBorderX col-md-3"> <img src="images/menu22.jpg" alt="volvo" class="img-responsive"> <a href="#">
                              ...
                              <!--                          <div class="col-md-3"><img src="images/volvo103.jpg" alt="volvo" class="img-responsive"><a href="#" class="volvoGray margin-top">
                                                        <p><strong>Give your machine more bite</strong></p>
                                                          ...
                                                          <p>The self-sharpening Volvo Tooth System withstands high stress levels and is a result of our commitment to innovation.</p>
                                                          <a href="#">Volvo hydraulic breakers <span class="glyphicon glyphicon-menu-left"></span></a><br>
                                                        </div>-->
                                                    </div>
                                                </li>
                                            </ul>
                              ...
                              <!--                          <div class="col-md-3"><img src="images/volvo103.jpg" alt="volvo" class="img-responsive"><a href="#" class="volvoGray margin-top">
                                        ...
                                        <li class="dropdown yamm-fw"><a id="locations" href="{{$menu_locations->url}}"  role="button" aria-haspopup="true" aria-expanded="false">{{$menu_locations->display_name}}</a></li>
                                        <li class="dropdown yamm-fw"><a href="{{$menu_contactus->url}}"  role="button" aria-haspopup="true" aria-expanded="false">{{$menu_contactus->display_name}}</a></li>
                                    </ul>
...
<p>{{$settings->text_ar}}</p>                            </div>
                            <?php //include("components/comp_locations/title_desc.php");
                            ?>
                            <div class="col-md-7 text-center">
                                {!!Form::open(['action'=>'VolvoPagesController@locations_ce_ar','method' => 'GET'])!!}
                                <div>
...
<!--                                            <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Service Centers <span class="glyphicon glyphicon-menu-down"></span><span class="sr-only">Toggle Dropdown</span></button>
            ...
            <div class="row footer">
                ...
                <div class="col-md-10 col-md-offset-1 footerBlack">
                    ...
                    |
                    <a href="/volvo_ce/contact_us_ar"> Contact Us</a>
                </div>
                <div class="col-md-10 col-md-offset-1 text-center volvoCopyright">
                    <img src="/volvo_ce/images/logoVolvo.png" alt="volvo">   Copyright AB Volvo 2017
                </div>
            </div>
...
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) --> 
	<script src="ar/js/jquery-1.11.3.min.js"></script>

	<!-- Include all compiled plugins (below), or include individual files as needed --> 
	<script src="ar/js/bootstrap.js"></script>
<script>
$('#myCarousel').carousel({
interval: 1000 * 10
});
