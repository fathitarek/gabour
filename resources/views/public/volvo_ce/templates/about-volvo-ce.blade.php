...
<!--      <div class="row headTitleX">
  <div class="col-md-10 col-md-offset-1">
      ...
      @include('public.'.$current_website->name.'.components.'.'.comp_volvo_about.'.$page['about']['component_template']['path'])
 ...
 @include('public.'.$current_website->name.'.components.'.'.comp_software.'.$page['p_right_image_second']['component_template']['path'])
  ...
  @include('public.'.$current_website->name.'.components.'.'.comp_software.'.$page['head_title_lower']['component_template']['path'])
      ...
      @include('public.'.$current_website->name.'.components.'.'.comp_volvo_about.'.$page['p_left_image_link']['component_template']['path'])
      @include('public.'.$current_website->name.'.components.'.'.comp_volvo_about.'.$page['p_right_image_link']['component_template']['path'])
