 <li class="dropdown yamm-fw"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$page['about_menu']['special_listing_1_data'][0]->display_name}}</a>
                      ...
                      <li>
                        <div class="row noPaddingX">
                          <div class="col-md-9 rightBorderX">
                            ...
                            <div class="row">
                                @foreach($page['about_menu']['special_listing_1_data'][0]->menuItems as $index =>$menu_item)
