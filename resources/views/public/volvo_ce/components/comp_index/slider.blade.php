        ...
        <div class="col-md-10 col-md-offset-1">
          <div id="carousel1" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              ...
              @if(count($page['ce_home_slider']['special_listing_1_data'][0]->sliderItems))
              <?php
		$slider_index=0;
		?>
            <div class="carousel-inner" role="listbox">
                 @foreach($page['ce_home_slider']['special_listing_1_data'][0]->sliderItems as $index =>$slider_item)
