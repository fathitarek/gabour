...
<div class="row heroImgX2">
      <div class="col-md-10 col-md-offset-1">
          <h4>{{$page['Product'][0]->title}}</h4>
          <h3>{{$page['Product'][0]->title2}}</h3>
      ...
      <div class="row headTitleX">
        <div class="col-md-10 col-md-offset-1">
          ...
          <h4>{{$page['Product'][0]->text_title_en}}</h4>
          <p>{{$page['Product'][0]->text_en}}</p>
        </div>
      </div>
...
@if($page['Product'][0]['youtube_id']!='')
    ...
    <div class="row headTitleX">
        <div class="col-md-10 col-md-offset-1">
            <h3>{{$page['Product'][0]['youtube_title_en']}}</h3>
            <p>{{$page['Product'][0]['description_en']}}</p>
        </div>
    </div>
